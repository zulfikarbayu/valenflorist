                        ...
                        <div class="col-md-8">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Edit Testimony</h3>
                                </div>
                                <div class="block-content">
                                    <div class="form-group">
                                        <input type="text" name="xjudul" value="<?php echo $b['tulisan_judul'];?>" class="form-control" placeholder="Testimony Title" required>
                                    </div>
                                    <div class="form-group">
