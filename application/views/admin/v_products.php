...
<html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
                        ...
                        <div class="col-md-12">
                            <div class="block">
                                <div class="block-header block-header-default">
                                    <h3 class="block-title">Flower Products</h3>
                                    <div class="block-options">
                                        <a href="<?php echo site_url('admin/product/add_new');?>" class="btn btn-primary"><span class="fa fa-plus"></span> Add New</a>
                                    </div>
                                </div>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="width: 90px;text-align: center;vertical-align: middle;">
                                                    <a href="<?php echo site_url('admin/product/get_edit/'.$row->kd_compare);?>" class="btn btn-sm btn-secondary btn-circle"><span class="fa fa-pencil"></span></a>
        ...
        <!-- Modal Hapus -->
        <form action="<?php echo base_url().'admin/product/hapus_product'?>" method="post">
                ...
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <p>Anda yakin mau menghapus product ini?</p>
